            ...
            <section className={style.visitcard}>
                <div className={style.visitcard_wrapper}>
                    ...
                    <div className={style.visitcard_text}>
                        ...
                        <h2>Our story began with a vision to create a unique dining experience that merges fine dining, exceptional service, and a vibrant ambiance. Rooted in the city&apos;s rich culinary culture, we aim to honor our local roots while infusing a global palate.</h2>
